...
> [!NOTE]
> I've seen `dmd_properties.h5` and `metadata@1702399188.h5`-like files in the Haystack data, but they either don't follow the Digital-RF specification or use an older version of it. Let's ignore them.
